...
class Visualizer:
    ...
    def visualize(
        ...
        if save_video:
            self.save_video(res_video, filename=filename, writer=writer, step=step, intensity=intensity)
        return res_video

    def save_video(self, video, filename, writer=None, step=0, intensity=1.0):
        video = video.float() * intensity
